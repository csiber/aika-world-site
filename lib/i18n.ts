  ...
  en: {
    ...
    home: {
      hero: {
        ...
        title: "Test the Hyper MST Pro V2 survival stack",
        subtitle:
      ...
      what: {
        ...
        description:
          "A narrative survival adventure grounded in the Hyper MST Pro V2 toolkit. You wake in the wreck of SYNCNODE’s interceptor, repair your systems one module at a time, and decide whether AIKA’s oversight keeps you alive or locks the planet down.",
        pillars: [
          {
      ...
      builders: {
        title: "Hyper MST Pro V2 pillars",
        intro:
      ...
      pulse: {
        ...
        intro:
          "Key metrics are gathered directly from the Hyper MST simulation: movement data, structure integrity, and AI suspicion. Watching them helps debug the same way it guides the story.",
        ...
        items: [
          {
            ...
            text: "Stress-test traversal, combat, and saving across the core Crash Basin biomes using the Hyper MST Pro V2 base.",
          },
          {
    ...
    systems: {
      title: "Hyper MST Pro V2 systems",
      subtitle:
      ...
      footnote:
        "The Hyper MST Pro V2 toolbox is the same one powering AIKA’s field missions—testing it advances both engineering and story planning.",
    },
    devlog: {
  ...
  hu: {
    ...
    home: {
      hero: {
        ...
        title: "Próbáld ki a Hyper MST Pro V2 túlélőkeretét",
        subtitle:
        ...
        note: "A szelet PC-n és böngészős streamen is fut, és már most a Hyper MST Pro V2 összes fő rendszerét használja.",
      ...
      what: {
        ...
        description:
          "Egy narratív túlélő történet, ahol egy SYNCNODE pilóta a Hyper MST Pro V2 moduljain keresztül rakja össze a múltját. Minden rendszer – a karakterkontrolltól az attribútkezelőig – ugyanazt a komponensláncot használja, amelyre a későbbi epizódok épülnek.",
        pillars: [
          {
            title: "Moduláris túlélő mag",
            text: "A karakterrendszer, a mozgás és a statkezelés ugyanazt a Hyper MST Pro V2 Abstract → Basic → Advanced láncot használja, mint a fejlesztői buildben.",
          },
          {
      ...
      builders: {
        title: "Hyper MST Pro V2 pillérei",
        intro:
      ...
      pulse: {
        ...
        intro:
          "A Hyper MST szimuláció közvetlen értékei: mozgásadatok, struktúra állapot és MI-figyelem. Ezek a grafikonok ugyanúgy segítik a fejlesztést, ahogy a pilótát.",
      ...
      roadmap: {
        ...
        intro: "A szelet minden lépésnél akkor bővül, amikor a játékréteg eléri a Hyper MST Pro V2 szintjét.",
        items: [
          {
            title: "Sandbox validáció",
            text: "Mozgás, harc és mentési lánc stressztesztelése a Zuhanási Medence kulcsbiomjaiban, a Hyper MST Pro V2 alapra támaszkodva.",
          },
          {
    ...
    systems: {
      title: "Hyper MST Pro V2 rendszerek",
      subtitle:
      ...
      footnote:
        "A Hyper MST Pro V2 eszköztár ugyanaz, amely AIKA terepküldetéseit hajtja – a teszteléssel egyszerre halad a technika és a történet.",
    },
    devlog: {
