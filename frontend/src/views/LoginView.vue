...
.input-group input { width: 100%; background: rgba(0,0,0,0.4); border: 1px solid var(--border); border-radius: 6px; padding: 12px 15px; color: #fff; font-size: 14px; outline: none; transition: all 0.3s; }
...
.auth-btn { width: 100%; padding: 14px; background: var(--accent); color: #000; border: none; border-radius: 6px; font-family: 'Orbitron', sans-serif; font-weight: 800; cursor: pointer; transition: all 0.3s; letter-spacing: 1px; }
...
.intro-trigger { margin-top: 20px; background: none; border: 1px solid var(--border); color: var(--text-dim); padding: 6px 15px; border-radius: 20px; font-size: 11px; cursor: pointer; transition: all 0.2s; }
...
.terminal-overlay { position: fixed; inset: 0; background: rgba(0,0,0,0.85); z-index: 1000; display: flex; align-items: center; justify-content: center; padding: 20px; }
.terminal-window { width: 100%; max-width: 600px; background: #0a0c10; border: 1px solid var(--border); border-radius: 8px; overflow: hidden; box-shadow: 0 30px 100px rgba(0,0,0,0.8); }
.terminal-header { background: #1a1c24; padding: 10px 15px; display: flex; align-items: center; gap: 15px; }
...
.terminal-btn { margin-top: 30px; background: rgba(0,255,204,0.1); border: 1px solid #00ffcc; color: #00ffcc; padding: 10px 20px; font-family: 'Orbitron', sans-serif; font-size: 11px; cursor: pointer; transition: all 0.3s; width: 100%; }
